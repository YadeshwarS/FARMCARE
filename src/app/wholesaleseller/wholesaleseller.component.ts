...
@Component({
  selector: 'app-wholesaleseller',
  templateUrl: './wholesaleseller.component.html',
  styleUrls: ['./wholesaleseller.component.css']
})
export class WholesalesellerComponent implements OnInit {
  dealer_name : string = '';
  id : string ='';
  p_name : string='';
  p_img_path : string='';
  ...
  addProduct(){
    ...
    this.product.category = this.category;
      this.auth.addWholeProduct(this.product);
      alert("Product added");
      this.reset();
    }
  }
